...
const words = ["monitor", "optimize", "adapt", "respond"];
...
function BlurWord({ word, trigger }: { word: string; trigger: number }) {
  ...
  const gradientColors = ["#3b82f6", "#60a5fa", "#67e8f9", "#93c5fd", "#3b82f6"];
  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center items-start overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 z-0">
        ...
        >
          <source src="/heroCar.webm" type="video/webm" />
        </video>
      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 lg:px-12 py-32 lg:py-40">
        ...
        <div className="mb-8">
          ...
          >
            <span className="block whitespace-nowrap">Traffic that knows how to</span>
      ...
      >
        <div className="max-w-[1400px] mx-auto flex items-start gap-10 lg:gap-20">
          {[
            { value: "1,240+", label: "vehicles simulated live" },
            { value: "SUMO", label: "real-time simulation engine" },
            { value: "<100ms", label: "signal response time" },
          ].map((stat) => (
